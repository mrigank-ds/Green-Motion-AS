...
export default function LocationVerticalResults(props: VerticalResultsProps): JSX.Element | null {
...
function Pagination(props: PaginationProps): JSX.Element | null {
  ...
  const NewLimits = useAnswersState(state => state.vertical.resultsCount);
